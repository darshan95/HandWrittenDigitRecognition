...
[img_tot lab_tot] = readsemion('train-images.idx3-ubyte','train-labels.idx1-ubyte', tot_num_imgs,offset);
%lab_t,ot
         ...
         %   figure;
          %  imshow(L);
            ...
            if stem_kk.NumObjects == 1
                ...
                %removing additional noise
                thresh = 2;
                for i=1:blob_tt.NumObjects
                    if (bwarea(T_blob(blob_tt.PixelIdxList{i})) < thresh)
                        T_blob(blob_tt.PixelIdxList{i}) = 1;
                    end
                end
